...
T2 = createmat2(seq1, seq2)
T2 = filMat2(seq1, seq2, T2)
print("a> The matrix for local alignment : ")
prinMat(T2)
i1,i2=findmaxind(T2)

bestseq(seq1, seq2, "", "", T2, i1, i2,0)
...
if(len(finalsol2)>1):
    print("There were more than one alignment with max score =",maxv)
else:
    print("There was a single alignment with score =",maxv)
